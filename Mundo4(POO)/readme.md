...
| :---: | :--- | :---: |
| **01** | O que é Objeto? (Teoria dos Fundamentos) | ✅ Concluído |
| **02** | Criando Classes e Objetos em Python (Prática) | ✅ Concluído |
...
| **08** | Abstração um dos Pilares Centrais da Programação Orientada a Objetos- Curso Python POO: Aula 8 | ❌ Pendente |
